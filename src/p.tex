...
\subsection{Remarks on S-polynomials}
...
\section{Yet another definition of Gr\"obner basis}
...
\begin{remark}
  ...
  \Cref{lem:elm}.
  We call sometimes a monomial order satisfying \Cref{lem:elm}
